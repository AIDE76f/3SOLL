...
ScreenGui.Name = "LegendaryMobileHub_V10"
...
Title.BackgroundTransparency = 1; Title.Text = "👑 Hub الأساطير V10"; Title.TextColor3 = Color3.fromRGB(255, 215, 0)
...
local triggerTick = 0
RunService:BindToRenderStep("MobileAimbotCore", Enum.RenderPriority.Camera.Value + 1, function()
    -- 1. Aimbot
